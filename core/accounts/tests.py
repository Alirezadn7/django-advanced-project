...
class AccountsAPITests(APITestCase):
    """
    Test suite for testing user authentication and profile endpoints.
    """

    def setUp(self):
        """
        Set up common test URLs and create a base test user.
    ...
    def test_registration(self):
        ...
        and that a Profile is created automatically by the signal.
        """
        new_data = {
        ...
        # Verify the profile was created for the new user
    ...
    def test_registration_fails_with_weak_password(self):
        """
        Test that registration is rejected if the password is too weak.
        """
    ...
    def test_custom_jwt_login(self):
        ...
        along with custom user data (email and first_name).
        """
    ...
    def test_retrieve_and_update_profile(self):
        """
        Test that an authenticated user can view and update their profile.
        """
    ...
    def test_change_password_success(self):
        ...
        by providing the correct old password.
        """
        self.client.force_authenticate(user=self.user)
        payload = {
